-- Create Gold layer aggregation stored procedures
...
BEGIN
    ...
    RETURN 'CITY_HEALTHCARE_ACCESS_AGG Created Successfully';
END;
$$;
...
BEGIN
    ...
    SELECT
        ...
        ROUND(
            100.0 * SUM(CASE WHEN TREATMENT_OUTCOME = 'Successful' THEN 1 ELSE 0 END)
            / NULLIF(COUNT(*), 0),
            2
        ) AS SUCCESS_RATE
...
BEGIN
    ...
    RETURN 'PATIENT_VALUE_AGG Created Successfully';
END;
$$;
