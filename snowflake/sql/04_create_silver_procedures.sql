-- Create Silver layer transformation stored procedures
...
BEGIN
    ...
    SELECT
        ...
        TRY_TO_DATE(DOB) AS PATIENT_DOB,
        DATEDIFF(YEAR, TRY_TO_DATE(DOB), CURRENT_DATE()) AS PATIENT_AGE,
...
BEGIN
    ...
    SELECT
        ...
        TRY_TO_DATE(V.VISIT_DATE) AS PATIENT_VISIT_DATE,
        T.TREATMENT_TYPE AS TREATMENT_TYPE,
        T.OUTCOME AS TREATMENT_OUTCOME,
        TRY_TO_DECIMAL(T.COST, 10, 2) AS TREATMENT_COST,
    ...
    JOIN AIRFLOW_DB.BRONZE.VISITS_RAW V
        ON T.VISIT_ID = V.VISIT_ID
    JOIN AIRFLOW_DB.BRONZE.PATIENTS_RAW P
        ON V.PATIENT_ID = P.PATIENT_ID
    JOIN AIRFLOW_DB.BRONZE.DOCTORS_RAW D
        ON V.DOCTOR_ID = D.DOCTOR_ID
    JOIN AIRFLOW_DB.BRONZE.HOSPITALS_RAW H
